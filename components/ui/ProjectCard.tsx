  ...
  return (
    <Card
      ...
      <CardFooter className="px-2 pb-2">
        {linkDisabled && (
          <Badge key={linkDisabled.toString()} className="flex gap-2 px-2 py-1 text-[10px]">
            {disabledIcon}
          </Badge>
        )}
