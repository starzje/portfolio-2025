    ...
    bg: (
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2
                      -translate-x-1/2 -translate-y-1/2 overflow-visible 
                      rounded-full bg-gradient-to-r
                      from-pink-500 via-rose-500 to-violet-600
                      opacity-70 blur-[20px] filter"
      />
    ),
  },
...
export default function CallToActionSection() {
  ...
  return (
    <section className="-mb-40" id="cta">
      <div className="py-14">
            ...
            <div className="absolute z-10">
              ...
              <BlurFade delay={0.1} direction="up" inView>
                <div className="z-10 mt-4 flex flex-col  items-center text-center text-primary ">
                  <h1 className="text-3xl font-bold lg:text-4xl">Focus on Your Business, Period.</h1>
                  <p className="mt-2"> Elevate your online presence while focusing on what you do best.</p>
                </div>
                <div className="absolute inset-0 -z-10 rounded-full  bg-gray-900 opacity-40 blur-xl " />
              </BlurFade>
            </div>
            <div className="absolute inset-x-0 bottom-0 h-full bg-gradient-to-b from-transparent to-gray-900 to-70% dark:to-gray-900" />
          </div>
        </div>
      </div>
    </section>
